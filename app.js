// First,Economic both-part  -Class part
// Way-01 solution

function InputFistCase(isIncrease,isDecrease,id){
    
    const firstCase=document.getElementById("id");
    ...
    if(isIncrease==false&&isDecrease==false&&firstCaseValue>0){
        firstCaseValueNew=firstCaseValue-1;
    }
